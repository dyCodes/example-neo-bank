...
const demoData = {
  ...
  'quick-actions': [
    ...
    },
    {
      ...
      description: 'Change your investment mix',
      icon: 'settings',
      iconColor: '#9333EA',
      route: '/invest?action=allocation',
    },
    {
      id: 'auto-invest',
  ...
  'widget-insights': [
    {
      ...
      description:
        "Your Treasury holdings are typically exempt from state and local taxes. You've saved an estimated $847 in taxes this year.",
      icon: 'clock',
      iconColor: '#9333EA',
    },
    {
      ...
      description:
        'Your portfolio is beating the S&P 500 by 3.44% this month. Great diversification strategy!',
      icon: 'check-circle',
      iconColor: '#10B981',
    },
    {
      ...
      description:
        'Your stock allocation has drifted 2% above target. Consider rebalancing to maintain your risk profile.',
      icon: 'alert-circle',
      iconColor: '#F97316',
      actionLabel: 'Review allocation →',
      actionLink: '/invest?action=allocation',
    },
  ],
};
