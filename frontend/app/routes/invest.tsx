...
export function meta({}: Route.MetaArgs) {
  return [
    { title: 'Invest' },
    { name: 'description', content: 'Investment portfolio' },
  ];
}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold">
                ${mockInvestmentBalance.toLocaleString()}
              </span>
            </div>
            <Separator />
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-lg font-semibold ${
                    mockTotalGain >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
                  ${Math.abs(mockTotalGain).toFixed(2)} ({mockTotalGainPercent > 0 ? '+' : ''}
                  {mockTotalGainPercent.toFixed(2)}%)
                </span>
              </div>
            </div>
          </div>
